...
const getAllRooms = wrapper(async (req: Request, res: Response, next: NextFunction) => {
...
const getRoomById = wrapper(async (req: Request, res: Response, next: NextFunction) => {
...
const getAllRoomTypes = wrapper(async (req: Request, res: Response, next: NextFunction) => {
...
const createRoomType = wrapper(async (req: Request, res: Response, next: NextFunction) => {
  const { name } = req.body;
  if (!name) {
  ...
  const type = await roomTypeModel.findOne({ name });
  if (!type) {
...
const createRoom = wrapper(async (req: Request, res: Response, next: NextFunction) => {
...
const updateRoom = wrapper(async (req: Request, res: Response, next: NextFunction) => {
...
const deleteRoom = wrapper(async (req: Request, res: Response, next: NextFunction) => {
  const { id } = req.body;
  const token = req.decodedToken;
  if (token?.role !== "Admin") {
    const err = new globalError(
